...
class Player:
    ...
    def command_start_digging(self, tunnels):
        """Jump to the left."""
    ...
    def is_there_solid_material(self, screen, x, y) -> bool:
...
def main():
    ...
    while running:
                ...
                for event in event_list:
                    ...
                    if event.type == pygame.KEYDOWN:
                        if (
                            ...
                            player.command_start_digging(tunnels)
                        elif (
                            event.key == pygame.K_RCTRL or event.key == pygame.K_LCTRL
        ...
        pygame.draw.rect(
            screen, (0, 0, 0), (BUTTON_X, BUTTON_Y, BUTTON_WDT, BUTTON_HGT)
        )
        pygame.draw.rect(
            screen,
            (255, 255, 255),
